...
import com.sdi.ws.EjbUsuariosService;
import com.sdi.ws.EjbUsuariosServiceService;
import com.sdi.ws.Usuario;

public class Main {

	static EjbUsuariosService usuariosService;
	private Scanner in;
	...
	private void run() throws Exception {
		usuariosService = new EjbUsuariosServiceService()
				.getEjbUsuariosServicePort();
	...
	private void addUser() {
		...
		try {
			usuariosService.insertarUsuario(id, nombre, apellidos, email,
					false, password, privilegios);
